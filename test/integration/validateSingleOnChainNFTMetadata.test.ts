...
import { NFTDetails } from '../../src/types/nfts';
...
describe('validateSingleOnChainNFTMetadata', () => {
  ...
  it('validates single NFT metadata successfully', async () => {
    mockedAxios.get
      ...
      .mockResolvedValueOnce({ data: VALID_NFT_METADATA });

    const validationResult = await Hip412Validator.validateSingleOnChainNFTMetadata(
      NETWORK,
      '0.0.3573355',
      1,
