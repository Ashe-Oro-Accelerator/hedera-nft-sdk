...
export const longE2ETimeout = 25000;
export const pathToOneLineCSV = 'test/__mocks__/testRows.csv';
export const pathToRowCSV = 'test/__mocks__/testRows.csv';
export const CSV_EXAMPLE_INVALID_HEADERS = 'test/__mocks__/csv/csvExampleInvalidHeaders.csv';
